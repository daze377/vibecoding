...
# headless. Adapted from ../fps-game/scripts/weapon.gd (single-player, no
# network): 25 dmg, 0.15 s cooldown, 30 rounds, 1.2 s reload.
class_name Weapon
extends RefCounted
...
func start_reload(now: float) -> void:
